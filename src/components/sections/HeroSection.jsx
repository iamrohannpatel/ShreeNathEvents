                    ...
                    >
                        ...
                        <div className="mt-6 flex justify-center">
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="flex items-center gap-2 px-6 py-2 bg-white/90 backdrop-blur-md text-amber-800 text-sm font-semibold rounded-full shadow-sm hover:bg-white hover:shadow-md transition-all border border-amber-100"
